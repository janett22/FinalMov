...
public class PerfilFragment extends Fragment {
    ...
    private void inicializarVista( View root) {
        ...
        etDni = root.findViewById(R.id.tvDNI);
        etNombre = root.findViewById(R.id.tvNombre);
        etApellido = root.findViewById(R.id.tvApellido);
        etEmail = root.findViewById(R.id.tvEmail);
        etContraseña = root.findViewById(R.id.etContraseña);
        etTelefono = root.findViewById(R.id.tvTelefono);
